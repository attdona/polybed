...
export function buildGraphData(rawData) {
  ...
  //console.log(rops)
  var measures = {
    "WeightedAvgRateRx": createArray("RateRx", weightedAvgRateRx),
    "WeightedAvgRateTx": createArray("RateTx", weightedAvgRateTx),
